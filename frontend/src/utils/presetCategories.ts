...
export const PRESET_PACKS: PresetPack[] = [
  ...
  {
    id: "freelancer",
    name: "Freelancer & Clients",
    emoji: "💼",
    description: "Organize client contracts, invoices, project deliverables, and client briefs.",
    ...
    categories: {
      "Client_Work/Contracts": {
        name: "Client_Work/Contracts",
        description: "Client contracts, statements of work, NDAs, and proposals",
        keywords: ["contract", "agreement", "nda", "proposal", "statement of work", "terms"],
        extensions: [".pdf", ".docx", ".doc"],
        active: true,
      },
      "Client_Work/Finances": {
        name: "Client_Work/Finances",
        description: "Client invoices, payment receipts, expense logs, and quotes",
        keywords: ["invoice", "bill", "payment", "receipt", "hourly rate", "timesheet"],
        extensions: [".pdf", ".xlsx", ".csv", ".docx"],
        active: true,
      },
      "Client_Work/Deliverables": {
        name: "Client_Work/Deliverables",
        description: "Final client assets, exports, mockups, and presentations",
        keywords: ["deliverable", "final", "export", "mockup", "presentation", "deck"],
        extensions: [".pdf", ".zip", ".png", ".jpg", ".pptx"],
        active: true,
      },
      "Work/Notes_and_Briefs": {
        name: "Work/Notes_and_Briefs",
        description: "Meeting agendas, project briefs, revision feedback, and notes",
        keywords: ["brief", "notes", "agenda", "feedback", "meeting", "minutes"],
  ...
  },
  {
    ...
    emoji: "🎓",
    description: "Lecture slides, assignments, research papers, study guides, and textbooks.",
    ...
    categories: {
      "Academic/Lecture_Notes": {
        ...
        description: "Lecture slides, class presentations, and professor handouts",
        keywords: ["lecture", "slides", "presentation", "week", "chapter", "professor"],
        extensions: [".pdf", ".pptx", ".ppt", ".docx"],
        active: true,
      },
      "Academic/Assignments": {
        name: "Academic/Assignments",
        description: "Coursework submissions, essays, homework, and lab reports",
        keywords: ["assignment", "homework", "essay", "submission", "lab report", "project"],
        extensions: [".pdf", ".docx", ".py", ".ipynb", ".txt"],
        active: true,
      },
      "Academic/Research_Papers": {
        name: "Academic/Research_Papers",
        description: "Scientific articles, journal papers, PDF studies, and citations",
        keywords: ["abstract", "journal", "ieee", "springer", "arxiv", "methodology", "doi", "bibliography"],
        extensions: [".pdf"],
        active: true,
      },
      "Academic/Study_Guides": {
        name: "Academic/Study_Guides",
        description: "Exam review notes, cheat sheets, summaries, and formula sheets",
        keywords: ["exam", "midterm", "final", "cheat sheet", "study guide", "review", "formula"],
        extensions: [".pdf", ".md", ".txt", ".docx"],
        active: true,
      },
      "Academic/Textbooks": {
        name: "Academic/Textbooks",
        description: "Digital course textbooks, reference manuals, and e-books",
        keywords: ["textbook", "edition", "volume", "handbook", "manual"],
        extensions: [".pdf", ".epub"],
        active: true,
      },
    },
  },
  {
    ...
    name: "Tax & Finance",
    emoji: "📊",
    description: "Invoices, receipts, tax filings (W2, 1099, IRS), and bank statements.",
    ...
    categories: {
      "Finance/Invoices": {
        name: "Finance/Invoices",
        description: "Vendor bills, contractor invoices, and payment requests",
        keywords: ["invoice", "bill", "billing", "amount due", "due date", "vendor"],
        extensions: [".pdf", ".png", ".jpg", ".docx"],
        active: true,
      },
      "Finance/Receipts": {
        name: "Finance/Receipts",
        description: "Proof of purchase, retail slips, order confirmations, and travel receipts",
        keywords: ["receipt", "order confirmation", "transaction", "paid", "subtotal", "merchant"],
        extensions: [".pdf", ".png", ".jpg", ".jpeg", ".webp"],
        active: true,
      },
      "Finance/Tax": {
        name: "Finance/Tax",
        description: "Tax returns, W2, 1099, tax deductions, and government revenue filings",
        keywords: ["tax", "w-2", "1099", "irs", "tax return", "deduction", "form 1040"],
        extensions: [".pdf", ".xlsx", ".csv"],
        active: true,
      },
      "Finance/Bank_Statements": {
        name: "Finance/Bank_Statements",
        description: "Bank statements, credit card statements, and investment summaries",
        keywords: ["statement", "account summary", "ending balance", "checking account", "savings account"],
        extensions: [".pdf", ".csv", ".xlsx"],
        active: true,
      },
    },
